...
public class TempleRanksOverview extends JPanel
{
	...
	public TempleRanksOverview()
	{
		...
		EHP = new TempleRanksOverviewSection("Ehp", "Efficient Hours Played", ColorScheme.DARKER_GRAY_COLOR);
		EHB = new TempleRanksOverviewSection("Ehb", "Efficient Hours Bossed", ColorScheme.DARK_GRAY_HOVER_COLOR);
		EXP = new TempleRanksOverviewSection("Xp", "Total Experience", ColorScheme.DARKER_GRAY_COLOR);
